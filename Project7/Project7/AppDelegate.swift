...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    func splitViewController(splitViewController: UISplitViewController, collapseSecondaryViewController secondaryViewController:UIViewController, ontoPrimaryViewController primaryViewController:UIViewController) -> Bool {
        ...
        guard let topAsDetailController = secondaryAsNavController.topViewController as? P7DetailViewController else { return false }
    ...
    func splitViewController(splitViewController: UISplitViewController, showDetailViewController vc: UIViewController, sender: AnyObject?) -> Bool {
        ...
        // collapsed 상태인 경우에만 기본 동작 변경
        // 기본 동작 : first child가 navigation controller인 경우에 pushViewController
        if (splitViewController.collapsed) {
            ...
            let detailViewController = (vc as! UINavigationController).topViewController!
